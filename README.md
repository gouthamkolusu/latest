...
- Shipping rate calculator (USPS, FedEx, UPS via EasyPost)
...
- Admin Orders dashboard with:
  ...
  - Generate & save tracking numbers
...
| Storage | JSON flat-file (products & orders) |
...
| Products Page | Checkout | Admin Orders |
|---|---|---|
| Browse with search & filters | Shipping rates + Stripe payment | Revenue summary + tracking |
