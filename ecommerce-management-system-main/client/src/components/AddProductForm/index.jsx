...
import fieldConfigData from '../../data/fieldConfig'; // default export
import InputField from '../InputField';
import './AddProductForm.css';
import { API_BASE } from '../../lib/apiBase'; // ✅ use constant (no init race)
                ...
                {form.images.map((img, i) => (
                  <div key={i} style={{ position: 'relative' }}>
                    ...
                    <FaTimesCircle
                      ...
                      style={{ position: 'absolute', top: '-6px', right: '-6px', cursor: 'pointer', fontSize: '18px' }}
